...
# utils-plot.R -------------------------------------------------------------
#
# Internal plotting infrastructure for pharos. These helpers implement the
...
#' pharos, lumen, alloy, hermes) live in this single namespace, e.g.
...
#'   for [pharos::stamp()] (e.g. `list(text = "...", las = 2)`).
