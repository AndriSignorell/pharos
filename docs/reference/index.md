...
- [`degToRad()`](https://andrisignorell.github.io/aurora/reference/degree-radians-conversion.md)
  [`radToDeg()`](https://andrisignorell.github.io/aurora/reference/degree-radians-conversion.md)
...
- [`htmlHat()`](https://andrisignorell.github.io/aurora/reference/htmlNotation.md)
  [`htmlBar()`](https://andrisignorell.github.io/aurora/reference/htmlNotation.md)
  : HTML notation for hat and bar diacritics

- [`` `%_%` ``](https://andrisignorell.github.io/aurora/reference/htmlSubscript.md)
  : Subscript notation
